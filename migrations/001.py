...
from playhouse.migrate import SqliteDatabase, SqliteMigrator, BooleanField, TextField, migrate
...
with db.atomic():
    migrate(
        ...
        migrator.add_column('notification', 'has_delete_button', BooleanField(default=False)),
    )
